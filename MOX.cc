...
double Power = AssemblyPower / RealActiveHeight *
...
string PerformDB(char** argv) {
  ...
  string PATHCMD =
      "ln -s $DATAPATH DATAPATH; ln -s $DATAPATH " + s_OUT + "/DATAPATH";
  ...
  gMURE->SetDATADIR(
      "/mnt/gluster/mouginot/mure/data.JEFF_3.1.1");
  ...
  cout << Power << " " << PowerDensity * gMURE->GetInitialHNMass() << endl;
